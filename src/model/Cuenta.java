...
public class Cuenta {
    ...
    public String generaIBAN(String pais, String entidad, String oficina, String dc, String cuenta) {
        // Pasar pais a numeros
        String paisNumerico = pasarPaisNumerico(pais);
        ...
        // Construir IBAN
        String iban = entidad + oficina + dc + cuenta + paisNumerico + digitoControl;
        ...
        // Reorganizar iban de nuevo
        iban = pais + digitoControl + iban.substring(0, iban.length() - 6);
